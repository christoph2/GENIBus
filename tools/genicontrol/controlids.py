...
ID_R_MIN                    = wx.NewId()
ID_R_MAX                    = wx.NewId()
ID_REF_REM_UNIT             = wx.NewId()
ID_REF_IR_UNIT              = wx.NewId()
ID_REF_ACT_UNIT             = wx.NewId()
ID_SYS_FB_UNIT              = wx.NewId()
ID_R_MIN_UNIT               = wx.NewId()
ID_R_MAX_UNIT               = wx.NewId()
...
ID_PARAM_UNIT_ADDR_UNIT       = wx.NewId()
ID_PARAM_GROUP_ADDR_UNIT      = wx.NewId()
ID_PARAM_H_CONST_REF_MIN_UNIT = wx.NewId()
ID_PARAM_H_CONST_REF_MAX_UNIT = wx.NewId()
ID_PARAM_H_PROP_REF_MIN_UNIT  = wx.NewId()
ID_PARAM_H_PROP_REF_MAX_UNIT  = wx.NewId()
...
ID_STR_SERIAL_NO            = wx.NewId()

##
##
ID_SET_REFERENCE_VALUES     = wx.NewId()
ID_SET_PARAMETER_VALUES     = wx.NewId()
